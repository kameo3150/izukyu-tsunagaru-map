...
const places = [
  ...
  },
  {
    ...
    large: false,
    verified: true,
    tags: ['カフェ', 'テラス席ペット可', 'リード着用', '白浜ビーチ前'],
    note: '下田市観光協会の掲載情報で、ペットはテラス席のみ利用可・リード着用を確認。住所は静岡県下田市白浜2752-16。施設ピン位置を確認して掲載しています。',
    kicker: '公式観光情報確認済み'
  },
  {
    name: '下田時計台フロント',
    ...
    large: false,
    verified: true,
    tags: ['駅前', 'ペット可', 'ケース必須', '食事・お土産'],
    note: '下田市観光協会の掲載情報でペット可を確認。ケース等に入れることが条件で、他のお客様への配慮が必要です。住所は静岡県下田市東本郷1-5-2。',
    kicker: '公式観光情報確認済み'
  },
  {
    ...
    large: false,
    verified: true,
    tags: ['レストラン', 'ウッドデッキ', 'ペット可', '入田浜'],
    note: '下田市観光協会の掲載情報で、ウッドデッキ内はペット可能と確認。住所は静岡県下田市吉佐美357-1。利用条件は来店前の確認がおすすめです。',
    kicker: '公式観光情報確認済み'
  },
  {
    name: '晴レ屋',
    ...
    large: false,
    verified: true,
    tags: ['愛犬と宿泊', '温泉宿', '外浦海岸', 'ペット歓迎'],
    note: '下田市観光協会で「ペット愛犬と泊まる」宿として掲載。外浦海岸すぐの天然温泉宿です。住所は静岡県下田市柿崎804。犬種や頭数など詳細条件は予約前に宿へ確認してください。',
    kicker: '公式観光情報確認済み'
  },
  {
    name: '貸別荘 ビラ小沢',
    ...
    large: false,
    verified: true,
    tags: ['貸別荘', 'ペット可', '一戸建て', 'BBQ可'],
    note: '下田市観光協会でペット可の一戸建て貸別荘として掲載。住所は静岡県下田市須崎156-7。棟ごとのペット条件は予約時に確認してください。',
    kicker: '公式観光情報確認済み'
  },
  {
    name: '活魚料理 新田',
    ...
    large: false,
    verified: true,
    tags: ['和食', 'ペット同伴室あり', '個室', 'ペリーロード'],
    note: '下田市観光協会の掲載情報で、ペットと同伴できる部屋が1室あることを確認。住所は静岡県下田市三丁目2-12。利用時は事前確認がおすすめです。',
    kicker: '公式観光情報確認済み'
  },
  {
    name: '伊豆海鮮 瀧',
    ...
    large: false,
    verified: true,
    tags: ['海鮮', 'ペット条件付き', 'ケージ等', '駅近'],
    note: '下田市観光協会の掲載情報で、ペットはケージ等に入れる条件で利用可能と確認。住所は静岡県下田市一丁目4-27。',
    kicker: '公式観光情報確認済み'
  },
  {
    name: 'むさし',
    ...
    large: false,
    verified: true,
    tags: ['そば・うどん', 'ペット条件付き', 'ケージ等', '駅近'],
    note: '下田市観光協会の掲載情報で、ペット同伴はケージ等を使用する条件付きで可と確認。住所は静岡県下田市一丁目13-1。',
    kicker: '公式観光情報確認済み'
  },
  {
    name: 'おおはし緑水苑',
